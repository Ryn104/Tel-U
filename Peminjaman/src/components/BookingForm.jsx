...
export default function BookingForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f2f2f2] to-white flex justify-center px-4 pt-5 pb-21">
      <div className="flex-col w-full max-w-2xl shadow-xl bg-white border border-gray-200 rounded-2xl p-8">
        <h1 className="text-3xl xl:text-5xl text-center font-bold text-[#002B5B]">
        ...
        <form onSubmit={handleSubmit} className="w-full grid grid-cols-1 gap-5">
          ...
          <button
            type="submit"
            className="btn w-full text-lg mt-2 bg-[#E60000] hover:bg-[#b80000] text-white border-none"
            disabled={isLoading}
          >
            {isLoading ? (
      ...
      <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-[90%] max-w-md">
        <div
          role="alert"
          className={`alert shadow-md text-black rounded-lg ${
