...
export default function ChatWidget() {
    ...
    return (
        <div className="fixed bottom-20 right-4 lg:bottom-22 lg:right-6 z-50">
            ...
            {/* Chat box */}
            {isOpen && (
                <div className="relative mt-2 shadow-xl bg-white border border-gray-200 rounded-2xl p-6 w-80">
                    {/* Tombol Close (X) */}
                    <button
                        onClick={toggleChat}
                    ...
                    {!hasSubmittedInfo ? (
                        <>
                            <h3 className="text-xl text-center text-[#002B5B] font-semibold mb-6">Informasi Pengguna</h3>
                            <form onSubmit={handleSubmitInfo} className="flex flex-col gap-3">
                                <input
                                    type="text"
                                    name="nama"
                                    placeholder="Nama"
                                ...
                                <input
                                    ...
                                    required
                                />
                                <button type="submit" className="btn bg-[#E60000] hover:bg-[#b80000] text-white border-none mt-4">Lanjut</button>
                                <div className='text-center'>
                                    <div className='w-full h-0.5 border-t border-gray-300 mb-1'></div>
                                    <span className='text-sm text-center text-gray-500'>Hubungi Langsung <a href="https://wa.me/6285711002971">+6285711002971</a> </span>
                                </div>
                            </form>
                        </>
                    ) : (
                        <>
                            <h3 className="text-xl text-center text-[#002B5B] font-semibold mb-6">Chat Admin</h3>
                            <form onSubmit={handleSubmitChat} className="flex flex-col gap-2">
                                ...
                                <button
                                    type="submit"
                                    className="btn bg-[#E60000] hover:bg-[#b80000] text-white border-none mt-4"
                                    disabled={loading}
                                >
